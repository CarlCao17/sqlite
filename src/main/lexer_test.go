...
func TestLex(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			Tokens: []token{
				{
					loc:   location{col: 0, row: 0},
					value: string(selectKeyword),
					kind:  keywordKind,
				},
				{
					loc:   location{col: 7, row: 0},
					value: "a",
					kind:  identifierKind,
				},
			},
		...
		},
		{
			...
			Tokens: []token{
				...
				{
					loc:   location{col: 13, row: 0},
					value: string(concatSymbol),
					kind:  symbolKind,
				},
				{
					loc:   location{col: 16, row: 0},
					value: "bar",
					kind:  stringKind,
				},
				{
					loc:   location{col: 21, row: 0},
		...
		},
		{
			...
			Tokens: []token{
				...
				{
					loc:   location{col: 19, row: 0},
					value: "int",
					kind:  keywordKind,
				},
				{
					loc:   location{col: 22, row: 0},
					value: ",",
					kind:  symbolKind,
				},
				{
					loc:   location{col: 24, row: 0},
					value: "name",
					kind:  identifierKind,
				},
				{
					loc:   location{col: 29, row: 0},
					value: "text",
					kind:  keywordKind,
				},
				{
					loc:   location{col: 33, row: 0},
					value: ")",
					kind:  symbolKind,
				},
			},
		},
		{
			...
			Tokens: []token{
				...
				{
					loc:   location{col: 12, row: 0},
					value: "users",
					kind:  identifierKind,
				},
				{
					loc:   location{col: 18, row: 0},
					value: string(valuesKeyword),
					kind:  keywordKind,
				},
				{
					loc:   location{col: 25, row: 0},
					value: "(",
					kind:  symbolKind,
				},
				{
					loc:   location{col: 26, row: 0},
					value: "105",
					kind:  numericKind,
				},
				{
					loc:   location{col: 30, row: 0},
					value: ",",
					kind:  symbolKind,
				},
				{
					loc:   location{col: 32, row: 0},
					value: "233",
					kind:  numericKind,
				},
				{
					loc:   location{col: 36, row: 0},
					value: ")",
					kind:  symbolKind,
				},
			},
